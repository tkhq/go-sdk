...
func newED25519Key() (*APIKey, error) {
...
// fromED25519Key extracts an ed25519 private key from a TK-encoded string and uses it to form an API key.
func fromED25519Key(encodedPrivateKey string) (*APIKey, error) {
