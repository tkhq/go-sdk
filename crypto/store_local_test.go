...
func TestGetKeyDirPathMacOSX(t *testing.T) {
	...
	assert.Equal(t, "/home/dir/.config/turnkey/keys", crypto.DefaultAPIKeysDir())
	assert.Equal(t, "/home/dir/.config/turnkey/encryption-keys", crypto.DefaultEncryptionKeysDir())
}
...
func TestGetKeyDirPathUnix(t *testing.T) {
	...
	assert.Equal(t, "/special/dir/turnkey/keys", crypto.DefaultAPIKeysDir())
	assert.Equal(t, "/special/dir/turnkey/encryption-keys", crypto.DefaultEncryptionKeysDir())
}
...
func TestGetAPIKeyDirPathOverride(t *testing.T) {
	...
	s := crypto.NewLocal[*crypto.EncryptionKey]()
