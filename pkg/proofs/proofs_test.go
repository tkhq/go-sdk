...
func TestVerify_ValidProofs(t *testing.T) {
	err := Verify(testAppProof1(), testBootProof1())
	require.NoError(t, err, "should verify valid proof pair 1")

	err = Verify(testAppProof2(), testBootProof2())
...
func TestVerify_MismatchedEphemeralKeys(t *testing.T) {
	...
	err := Verify(appProof1, malformedBootProof)
	...
	err = Verify(appProof1, bootProof1)
...
func TestVerify_ManifestDigestMismatch(t *testing.T) {
	...
	malformedBootProof := testBootProof1()
	malformedBootProof.QosManifestB64 = ptr("puwpDDoA3dqZpFV0nDnSgj2iFyy2VDUnDSE7u+awts0=")
	err := Verify(appProof1, malformedBootProof)
...
func TestVerify_InvalidSignatureScheme(t *testing.T) {
	...
	invalidScheme := models.DataV1SignatureScheme("INVALID_SCHEME")
...
func TestVerify_InvalidPublicKeyLength(t *testing.T) {
	...
	appProof.PublicKey = ptr("043144c138d522996833f9a5352b98da2ba669f1ab3f712b243a1993c89c7d682f2163c4c63c6625c483cd5e8714e9a2039e1ec05cebadf469a4adb7e721d16e19")
