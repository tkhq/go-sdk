...
// V1CreateOrganizationIntentV2 v1 create organization intent v2
//
...
// Validate validates this v1 create organization intent v2
func (m *V1CreateOrganizationIntentV2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1CreateOrganizationIntentV2) validateOrganizationName(formats strfmt.Registry) error {
...
func (m *V1CreateOrganizationIntentV2) validateRootAuthenticator(formats strfmt.Registry) error {
...
func (m *V1CreateOrganizationIntentV2) validateRootEmail(formats strfmt.Registry) error {
...
// ContextValidate validate this v1 create organization intent v2 based on the context it is used
func (m *V1CreateOrganizationIntentV2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1CreateOrganizationIntentV2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1CreateOrganizationIntentV2) UnmarshalBinary(b []byte) error {
	var res V1CreateOrganizationIntentV2
