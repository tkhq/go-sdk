...
func (m *GetActivityRequest) validateActivityID(formats strfmt.Registry) error {
...
func (m *GetActivityRequest) validateOrganizationID(formats strfmt.Registry) error {
