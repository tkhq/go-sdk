...
func (m *AcceptInvitationIntent) validateAuthenticator(formats strfmt.Registry) error {
...
func (m *AcceptInvitationIntent) validateInvitationID(formats strfmt.Registry) error {
...
func (m *AcceptInvitationIntent) validateUserID(formats strfmt.Registry) error {
...
func (m *AcceptInvitationIntent) contextValidateAuthenticator(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AcceptInvitationIntent) UnmarshalBinary(b []byte) error {
	var res AcceptInvitationIntent
