...
func (m *SetOrganizationFeatureResult) validateFeatures(formats strfmt.Registry) error {
...
func (m *SetOrganizationFeatureResult) contextValidateFeatures(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SetOrganizationFeatureResult) UnmarshalBinary(b []byte) error {
	var res SetOrganizationFeatureResult
