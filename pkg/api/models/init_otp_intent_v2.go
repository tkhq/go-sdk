...
// InitOtpIntentV2 init otp intent v2
//
// swagger:model InitOtpIntentV2
...
// Validate validates this init otp intent v2
func (m *InitOtpIntentV2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InitOtpIntentV2) validateAppName(formats strfmt.Registry) error {
...
func (m *InitOtpIntentV2) validateContact(formats strfmt.Registry) error {
...
func (m *InitOtpIntentV2) validateEmailCustomization(formats strfmt.Registry) error {
...
func (m *InitOtpIntentV2) validateOtpType(formats strfmt.Registry) error {
...
func (m *InitOtpIntentV2) validateSmsCustomization(formats strfmt.Registry) error {
...
// ContextValidate validate this init otp intent v2 based on the context it is used
func (m *InitOtpIntentV2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InitOtpIntentV2) contextValidateEmailCustomization(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InitOtpIntentV2) contextValidateSmsCustomization(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InitOtpIntentV2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InitOtpIntentV2) UnmarshalBinary(b []byte) error {
	var res InitOtpIntentV2
