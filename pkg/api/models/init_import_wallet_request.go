...
func (m *InitImportWalletRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *InitImportWalletRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *InitImportWalletRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var initImportWalletRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_INIT_IMPORT_WALLET"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		initImportWalletRequestTypeTypePropEnum = append(initImportWalletRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *InitImportWalletRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, initImportWalletRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *InitImportWalletRequest) validateType(formats strfmt.Registry) error {
...
func (m *InitImportWalletRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InitImportWalletRequest) UnmarshalBinary(b []byte) error {
	var res InitImportWalletRequest
