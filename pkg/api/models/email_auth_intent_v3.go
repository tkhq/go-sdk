...
// EmailAuthIntentV3 email auth intent v3
//
// swagger:model EmailAuthIntentV3
...
// Validate validates this email auth intent v3
...
func (m *EmailAuthIntentV3) validateTargetPublicKey(formats strfmt.Registry) error {
...
// ContextValidate validate this email auth intent v3 based on the context it is used
func (m *EmailAuthIntentV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EmailAuthIntentV3) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EmailAuthIntentV3) UnmarshalBinary(b []byte) error {
	var res EmailAuthIntentV3
