...
func (m *ExportPrivateKeyRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *ExportPrivateKeyRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *ExportPrivateKeyRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var exportPrivateKeyRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		exportPrivateKeyRequestTypeTypePropEnum = append(exportPrivateKeyRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *ExportPrivateKeyRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, exportPrivateKeyRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ExportPrivateKeyRequest) validateType(formats strfmt.Registry) error {
...
func (m *ExportPrivateKeyRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExportPrivateKeyRequest) UnmarshalBinary(b []byte) error {
	var res ExportPrivateKeyRequest
