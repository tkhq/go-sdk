...
func (m *VerifyOtpRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *VerifyOtpRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *VerifyOtpRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var verifyOtpRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		verifyOtpRequestTypeTypePropEnum = append(verifyOtpRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *VerifyOtpRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, verifyOtpRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *VerifyOtpRequest) validateType(formats strfmt.Registry) error {
...
func (m *VerifyOtpRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
