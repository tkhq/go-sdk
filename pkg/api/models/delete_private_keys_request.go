...
func (m *DeletePrivateKeysRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *DeletePrivateKeysRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *DeletePrivateKeysRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var deletePrivateKeysRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_DELETE_PRIVATE_KEYS"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		deletePrivateKeysRequestTypeTypePropEnum = append(deletePrivateKeysRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *DeletePrivateKeysRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deletePrivateKeysRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DeletePrivateKeysRequest) validateType(formats strfmt.Registry) error {
...
func (m *DeletePrivateKeysRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeletePrivateKeysRequest) UnmarshalBinary(b []byte) error {
	var res DeletePrivateKeysRequest
