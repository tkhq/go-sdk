...
func (m *CreateUsersRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *CreateUsersRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *CreateUsersRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var createUsersRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_CREATE_USERS_V3"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		createUsersRequestTypeTypePropEnum = append(createUsersRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *CreateUsersRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createUsersRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CreateUsersRequest) validateType(formats strfmt.Registry) error {
...
func (m *CreateUsersRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
