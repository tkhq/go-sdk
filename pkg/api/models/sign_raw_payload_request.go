...
func (m *SignRawPayloadRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *SignRawPayloadRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *SignRawPayloadRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var signRawPayloadRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		signRawPayloadRequestTypeTypePropEnum = append(signRawPayloadRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *SignRawPayloadRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, signRawPayloadRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SignRawPayloadRequest) validateType(formats strfmt.Registry) error {
...
func (m *SignRawPayloadRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
