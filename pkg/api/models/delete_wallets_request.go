...
func (m *DeleteWalletsRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *DeleteWalletsRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *DeleteWalletsRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var deleteWalletsRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_DELETE_WALLETS"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		deleteWalletsRequestTypeTypePropEnum = append(deleteWalletsRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *DeleteWalletsRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deleteWalletsRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DeleteWalletsRequest) validateType(formats strfmt.Registry) error {
...
func (m *DeleteWalletsRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
