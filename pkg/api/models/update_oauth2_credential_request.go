...
func (m *UpdateOauth2CredentialRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *UpdateOauth2CredentialRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *UpdateOauth2CredentialRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var updateOauth2CredentialRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_UPDATE_OAUTH2_CREDENTIAL"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		updateOauth2CredentialRequestTypeTypePropEnum = append(updateOauth2CredentialRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *UpdateOauth2CredentialRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, updateOauth2CredentialRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *UpdateOauth2CredentialRequest) validateType(formats strfmt.Registry) error {
...
func (m *UpdateOauth2CredentialRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateOauth2CredentialRequest) UnmarshalBinary(b []byte) error {
	var res UpdateOauth2CredentialRequest
