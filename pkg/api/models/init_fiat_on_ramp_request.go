...
func (m *InitFiatOnRampRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *InitFiatOnRampRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *InitFiatOnRampRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var initFiatOnRampRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_INIT_FIAT_ON_RAMP"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		initFiatOnRampRequestTypeTypePropEnum = append(initFiatOnRampRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *InitFiatOnRampRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, initFiatOnRampRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *InitFiatOnRampRequest) validateType(formats strfmt.Registry) error {
...
func (m *InitFiatOnRampRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
