...
// InitOtpIntentV3 init otp intent v3
//
// swagger:model InitOtpIntentV3
...
// Validate validates this init otp intent v3
func (m *InitOtpIntentV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InitOtpIntentV3) validateAppName(formats strfmt.Registry) error {
...
func (m *InitOtpIntentV3) validateContact(formats strfmt.Registry) error {
...
func (m *InitOtpIntentV3) validateEmailCustomization(formats strfmt.Registry) error {
...
func (m *InitOtpIntentV3) validateOtpType(formats strfmt.Registry) error {
...
func (m *InitOtpIntentV3) validateSmsCustomization(formats strfmt.Registry) error {
...
// ContextValidate validate this init otp intent v3 based on the context it is used
func (m *InitOtpIntentV3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InitOtpIntentV3) contextValidateEmailCustomization(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InitOtpIntentV3) contextValidateSmsCustomization(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InitOtpIntentV3) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InitOtpIntentV3) UnmarshalBinary(b []byte) error {
	var res InitOtpIntentV3
