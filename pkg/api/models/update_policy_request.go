...
func (m *UpdatePolicyRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *UpdatePolicyRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *UpdatePolicyRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var updatePolicyRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		updatePolicyRequestTypeTypePropEnum = append(updatePolicyRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *UpdatePolicyRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, updatePolicyRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *UpdatePolicyRequest) validateType(formats strfmt.Registry) error {
...
func (m *UpdatePolicyRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
