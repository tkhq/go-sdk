...
func (m *ImportWalletRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *ImportWalletRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *ImportWalletRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var importWalletRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_IMPORT_WALLET"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		importWalletRequestTypeTypePropEnum = append(importWalletRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *ImportWalletRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, importWalletRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ImportWalletRequest) validateType(formats strfmt.Registry) error {
...
func (m *ImportWalletRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
