...
func (m *InitUserEmailRecoveryRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *InitUserEmailRecoveryRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *InitUserEmailRecoveryRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var initUserEmailRecoveryRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		initUserEmailRecoveryRequestTypeTypePropEnum = append(initUserEmailRecoveryRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *InitUserEmailRecoveryRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, initUserEmailRecoveryRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *InitUserEmailRecoveryRequest) validateType(formats strfmt.Registry) error {
...
func (m *InitUserEmailRecoveryRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InitUserEmailRecoveryRequest) UnmarshalBinary(b []byte) error {
	var res InitUserEmailRecoveryRequest
