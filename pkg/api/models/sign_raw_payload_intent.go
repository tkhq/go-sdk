...
func (m *SignRawPayloadIntent) validateEncoding(formats strfmt.Registry) error {
...
func (m *SignRawPayloadIntent) validateHashFunction(formats strfmt.Registry) error {
...
func (m *SignRawPayloadIntent) validatePayload(formats strfmt.Registry) error {
...
func (m *SignRawPayloadIntent) validatePrivateKeyID(formats strfmt.Registry) error {
...
func (m *SignRawPayloadIntent) contextValidateEncoding(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SignRawPayloadIntent) contextValidateHashFunction(ctx context.Context, formats strfmt.Registry) error {
