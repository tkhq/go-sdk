...
func (m *RemoveOrganizationFeatureResult) validateFeatures(formats strfmt.Registry) error {
...
func (m *RemoveOrganizationFeatureResult) contextValidateFeatures(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RemoveOrganizationFeatureResult) UnmarshalBinary(b []byte) error {
	var res RemoveOrganizationFeatureResult
