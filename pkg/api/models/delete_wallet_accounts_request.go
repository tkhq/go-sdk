...
func (m *DeleteWalletAccountsRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *DeleteWalletAccountsRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *DeleteWalletAccountsRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var deleteWalletAccountsRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_DELETE_WALLET_ACCOUNTS"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		deleteWalletAccountsRequestTypeTypePropEnum = append(deleteWalletAccountsRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *DeleteWalletAccountsRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deleteWalletAccountsRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DeleteWalletAccountsRequest) validateType(formats strfmt.Registry) error {
...
func (m *DeleteWalletAccountsRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeleteWalletAccountsRequest) UnmarshalBinary(b []byte) error {
	var res DeleteWalletAccountsRequest
