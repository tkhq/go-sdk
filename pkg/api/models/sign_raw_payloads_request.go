...
func (m *SignRawPayloadsRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *SignRawPayloadsRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *SignRawPayloadsRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var signRawPayloadsRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_SIGN_RAW_PAYLOADS"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		signRawPayloadsRequestTypeTypePropEnum = append(signRawPayloadsRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *SignRawPayloadsRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, signRawPayloadsRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SignRawPayloadsRequest) validateType(formats strfmt.Registry) error {
...
func (m *SignRawPayloadsRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SignRawPayloadsRequest) UnmarshalBinary(b []byte) error {
	var res SignRawPayloadsRequest
