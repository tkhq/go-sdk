...
func (m *CreateSmartContractInterfaceRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *CreateSmartContractInterfaceRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *CreateSmartContractInterfaceRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var createSmartContractInterfaceRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_CREATE_SMART_CONTRACT_INTERFACE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		createSmartContractInterfaceRequestTypeTypePropEnum = append(createSmartContractInterfaceRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *CreateSmartContractInterfaceRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createSmartContractInterfaceRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CreateSmartContractInterfaceRequest) validateType(formats strfmt.Registry) error {
...
func (m *CreateSmartContractInterfaceRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateSmartContractInterfaceRequest) UnmarshalBinary(b []byte) error {
	var res CreateSmartContractInterfaceRequest
