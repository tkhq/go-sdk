...
func (m *CreatePolicyRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *CreatePolicyRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *CreatePolicyRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var createPolicyRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		createPolicyRequestTypeTypePropEnum = append(createPolicyRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *CreatePolicyRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createPolicyRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CreatePolicyRequest) validateType(formats strfmt.Registry) error {
...
func (m *CreatePolicyRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
