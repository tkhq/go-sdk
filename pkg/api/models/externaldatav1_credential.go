...
// Externaldatav1Credential externaldatav1 credential
//
// swagger:model externaldatav1Credential
...
// Validate validates this externaldatav1 credential
...
func (m *Externaldatav1Credential) validatePublicKey(formats strfmt.Registry) error {
...
func (m *Externaldatav1Credential) validateType(formats strfmt.Registry) error {
...
// ContextValidate validate this externaldatav1 credential based on the context it is used
...
func (m *Externaldatav1Credential) UnmarshalBinary(b []byte) error {
	var res Externaldatav1Credential
