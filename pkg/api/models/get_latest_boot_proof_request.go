...
func (m *GetLatestBootProofRequest) validateAppName(formats strfmt.Registry) error {
...
func (m *GetLatestBootProofRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *GetLatestBootProofRequest) UnmarshalBinary(b []byte) error {
	var res GetLatestBootProofRequest
