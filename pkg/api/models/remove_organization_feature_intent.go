...
func (m *RemoveOrganizationFeatureIntent) validateName(formats strfmt.Registry) error {
...
func (m *RemoveOrganizationFeatureIntent) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RemoveOrganizationFeatureIntent) UnmarshalBinary(b []byte) error {
	var res RemoveOrganizationFeatureIntent
