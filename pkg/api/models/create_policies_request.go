...
func (m *CreatePoliciesRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *CreatePoliciesRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *CreatePoliciesRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var createPoliciesRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_CREATE_POLICIES"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		createPoliciesRequestTypeTypePropEnum = append(createPoliciesRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *CreatePoliciesRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createPoliciesRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CreatePoliciesRequest) validateType(formats strfmt.Registry) error {
...
func (m *CreatePoliciesRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
