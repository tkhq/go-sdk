...
func (m *AcceptInvitationIntentV2) validateAuthenticator(formats strfmt.Registry) error {
...
func (m *AcceptInvitationIntentV2) validateInvitationID(formats strfmt.Registry) error {
...
func (m *AcceptInvitationIntentV2) validateUserID(formats strfmt.Registry) error {
...
func (m *AcceptInvitationIntentV2) UnmarshalBinary(b []byte) error {
	var res AcceptInvitationIntentV2
