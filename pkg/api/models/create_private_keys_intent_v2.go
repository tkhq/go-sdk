...
func (m *CreatePrivateKeysIntentV2) validatePrivateKeys(formats strfmt.Registry) error {
...
func (m *CreatePrivateKeysIntentV2) contextValidatePrivateKeys(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreatePrivateKeysIntentV2) UnmarshalBinary(b []byte) error {
	var res CreatePrivateKeysIntentV2
