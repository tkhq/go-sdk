...
func (m *Attestation) validateAttestationObject(formats strfmt.Registry) error {
...
func (m *Attestation) validateClientDataJSON(formats strfmt.Registry) error {
...
func (m *Attestation) validateCredentialID(formats strfmt.Registry) error {
...
func (m *Attestation) validateTransports(formats strfmt.Registry) error {
