...
func (m *CreateInvitationsRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *CreateInvitationsRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *CreateInvitationsRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var createInvitationsRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		createInvitationsRequestTypeTypePropEnum = append(createInvitationsRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *CreateInvitationsRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createInvitationsRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CreateInvitationsRequest) validateType(formats strfmt.Registry) error {
...
func (m *CreateInvitationsRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateInvitationsRequest) UnmarshalBinary(b []byte) error {
	var res CreateInvitationsRequest
