...
func (m *GetWalletAccountsResponse) validateAccounts(formats strfmt.Registry) error {
...
func (m *GetWalletAccountsResponse) contextValidateAccounts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetWalletAccountsResponse) UnmarshalBinary(b []byte) error {
	var res GetWalletAccountsResponse
