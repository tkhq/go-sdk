...
func (m *CreateWalletAccountsRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *CreateWalletAccountsRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *CreateWalletAccountsRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var createWalletAccountsRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		createWalletAccountsRequestTypeTypePropEnum = append(createWalletAccountsRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *CreateWalletAccountsRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createWalletAccountsRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CreateWalletAccountsRequest) validateType(formats strfmt.Registry) error {
...
func (m *CreateWalletAccountsRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateWalletAccountsRequest) UnmarshalBinary(b []byte) error {
	var res CreateWalletAccountsRequest
