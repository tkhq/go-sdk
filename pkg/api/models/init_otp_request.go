...
func (m *InitOtpRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *InitOtpRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *InitOtpRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var initOtpRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_INIT_OTP"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		initOtpRequestTypeTypePropEnum = append(initOtpRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *InitOtpRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, initOtpRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *InitOtpRequest) validateType(formats strfmt.Registry) error {
...
func (m *InitOtpRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
