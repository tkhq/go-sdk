...
func (m *DeleteAPIKeysIntent) validateAPIKeyIds(formats strfmt.Registry) error {
...
func (m *DeleteAPIKeysIntent) validateUserID(formats strfmt.Registry) error {
