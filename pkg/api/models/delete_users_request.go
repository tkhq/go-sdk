...
func (m *DeleteUsersRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *DeleteUsersRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *DeleteUsersRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var deleteUsersRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_DELETE_USERS"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		deleteUsersRequestTypeTypePropEnum = append(deleteUsersRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *DeleteUsersRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deleteUsersRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DeleteUsersRequest) validateType(formats strfmt.Registry) error {
...
func (m *DeleteUsersRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
