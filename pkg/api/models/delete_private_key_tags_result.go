...
func (m *DeletePrivateKeyTagsResult) validatePrivateKeyIds(formats strfmt.Registry) error {
...
func (m *DeletePrivateKeyTagsResult) validatePrivateKeyTagIds(formats strfmt.Registry) error {
...
func (m *DeletePrivateKeyTagsResult) UnmarshalBinary(b []byte) error {
	var res DeletePrivateKeyTagsResult
