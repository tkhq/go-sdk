...
func (m *GetPolicyRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *GetPolicyRequest) validatePolicyID(formats strfmt.Registry) error {
