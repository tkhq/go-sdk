...
func (m *GetAuthenticatorsRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *GetAuthenticatorsRequest) validateUserID(formats strfmt.Registry) error {
...
func (m *GetAuthenticatorsRequest) UnmarshalBinary(b []byte) error {
	var res GetAuthenticatorsRequest
