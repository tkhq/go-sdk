...
func (m *CreateSubOrganizationIntentV2) validateRootQuorumThreshold(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV2) validateRootUsers(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV2) validateSubOrganizationName(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV2) contextValidateRootUsers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV2) UnmarshalBinary(b []byte) error {
	var res CreateSubOrganizationIntentV2
