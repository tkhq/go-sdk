...
func (m *CreatePoliciesIntent) validatePolicies(formats strfmt.Registry) error {
...
func (m *CreatePoliciesIntent) contextValidatePolicies(ctx context.Context, formats strfmt.Registry) error {
