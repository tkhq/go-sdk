...
func (m *CreateSubOrganizationIntentV7) validateRootQuorumThreshold(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV7) validateRootUsers(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV7) validateSubOrganizationName(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV7) validateWallet(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV7) contextValidateRootUsers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV7) contextValidateWallet(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV7) UnmarshalBinary(b []byte) error {
	var res CreateSubOrganizationIntentV7
