...
func (m *CreateUsersIntentV2) validateUsers(formats strfmt.Registry) error {
...
func (m *CreateUsersIntentV2) contextValidateUsers(ctx context.Context, formats strfmt.Registry) error {
