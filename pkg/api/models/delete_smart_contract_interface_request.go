...
func (m *DeleteSmartContractInterfaceRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *DeleteSmartContractInterfaceRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *DeleteSmartContractInterfaceRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var deleteSmartContractInterfaceRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_DELETE_SMART_CONTRACT_INTERFACE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		deleteSmartContractInterfaceRequestTypeTypePropEnum = append(deleteSmartContractInterfaceRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *DeleteSmartContractInterfaceRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deleteSmartContractInterfaceRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DeleteSmartContractInterfaceRequest) validateType(formats strfmt.Registry) error {
...
func (m *DeleteSmartContractInterfaceRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeleteSmartContractInterfaceRequest) UnmarshalBinary(b []byte) error {
	var res DeleteSmartContractInterfaceRequest
