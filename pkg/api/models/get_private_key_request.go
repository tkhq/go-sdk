...
func (m *GetPrivateKeyRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *GetPrivateKeyRequest) validatePrivateKeyID(formats strfmt.Registry) error {
