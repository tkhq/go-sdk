...
func (m *OtpLoginRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *OtpLoginRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *OtpLoginRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var otpLoginRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		otpLoginRequestTypeTypePropEnum = append(otpLoginRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *OtpLoginRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, otpLoginRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *OtpLoginRequest) validateType(formats strfmt.Registry) error {
...
func (m *OtpLoginRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
