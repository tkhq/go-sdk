...
func (m *CreateUsersIntentV3) validateUsers(formats strfmt.Registry) error {
...
func (m *CreateUsersIntentV3) contextValidateUsers(ctx context.Context, formats strfmt.Registry) error {
