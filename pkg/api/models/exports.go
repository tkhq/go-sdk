...
// ActivityStatuses returns the set of valid activity status values.
func ActivityStatuses() (out []V1ActivityStatus) {
	for _, s := range v1ActivityStatusEnum {
		out = append(out, s.(V1ActivityStatus))
	}
