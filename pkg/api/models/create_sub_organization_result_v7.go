...
func (m *CreateSubOrganizationResultV7) validateSubOrganizationID(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationResultV7) validateWallet(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationResultV7) contextValidateWallet(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationResultV7) UnmarshalBinary(b []byte) error {
	var res CreateSubOrganizationResultV7
