...
func (m *EmailAuthRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *EmailAuthRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *EmailAuthRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var emailAuthRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_EMAIL_AUTH"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		emailAuthRequestTypeTypePropEnum = append(emailAuthRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *EmailAuthRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, emailAuthRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *EmailAuthRequest) validateType(formats strfmt.Registry) error {
...
func (m *EmailAuthRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
