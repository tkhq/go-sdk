...
func (m *UpdateUserRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *UpdateUserRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *UpdateUserRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var updateUserRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		updateUserRequestTypeTypePropEnum = append(updateUserRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *UpdateUserRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, updateUserRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *UpdateUserRequest) validateType(formats strfmt.Registry) error {
...
func (m *UpdateUserRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
