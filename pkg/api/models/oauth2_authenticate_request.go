...
func (m *Oauth2AuthenticateRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *Oauth2AuthenticateRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *Oauth2AuthenticateRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var oauth2AuthenticateRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_OAUTH2_AUTHENTICATE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		oauth2AuthenticateRequestTypeTypePropEnum = append(oauth2AuthenticateRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *Oauth2AuthenticateRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, oauth2AuthenticateRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Oauth2AuthenticateRequest) validateType(formats strfmt.Registry) error {
...
func (m *Oauth2AuthenticateRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Oauth2AuthenticateRequest) UnmarshalBinary(b []byte) error {
	var res Oauth2AuthenticateRequest
