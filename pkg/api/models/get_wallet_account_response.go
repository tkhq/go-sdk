...
func (m *GetWalletAccountResponse) validateAccount(formats strfmt.Registry) error {
...
func (m *GetWalletAccountResponse) contextValidateAccount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetWalletAccountResponse) UnmarshalBinary(b []byte) error {
	var res GetWalletAccountResponse
