...
func (m *CreateAuthenticatorsIntent) validateAuthenticators(formats strfmt.Registry) error {
...
func (m *CreateAuthenticatorsIntent) validateUserID(formats strfmt.Registry) error {
...
func (m *CreateAuthenticatorsIntent) contextValidateAuthenticators(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateAuthenticatorsIntent) UnmarshalBinary(b []byte) error {
	var res CreateAuthenticatorsIntent
