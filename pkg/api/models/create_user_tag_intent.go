...
func (m *CreateUserTagIntent) validateUserIds(formats strfmt.Registry) error {
...
func (m *CreateUserTagIntent) validateUserTagName(formats strfmt.Registry) error {
