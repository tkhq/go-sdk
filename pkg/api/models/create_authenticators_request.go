...
func (m *CreateAuthenticatorsRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *CreateAuthenticatorsRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *CreateAuthenticatorsRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var createAuthenticatorsRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		createAuthenticatorsRequestTypeTypePropEnum = append(createAuthenticatorsRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *CreateAuthenticatorsRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createAuthenticatorsRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CreateAuthenticatorsRequest) validateType(formats strfmt.Registry) error {
...
func (m *CreateAuthenticatorsRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateAuthenticatorsRequest) UnmarshalBinary(b []byte) error {
	var res CreateAuthenticatorsRequest
