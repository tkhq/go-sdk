...
func (m *CreateSubOrganizationIntentV6) validateRootQuorumThreshold(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV6) validateRootUsers(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV6) validateSubOrganizationName(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV6) validateWallet(formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV6) contextValidateRootUsers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV6) contextValidateWallet(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateSubOrganizationIntentV6) UnmarshalBinary(b []byte) error {
	var res CreateSubOrganizationIntentV6
