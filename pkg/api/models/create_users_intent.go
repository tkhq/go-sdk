...
func (m *CreateUsersIntent) validateUsers(formats strfmt.Registry) error {
...
func (m *CreateUsersIntent) contextValidateUsers(ctx context.Context, formats strfmt.Registry) error {
