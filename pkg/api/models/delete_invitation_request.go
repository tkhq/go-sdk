...
func (m *DeleteInvitationRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *DeleteInvitationRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *DeleteInvitationRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var deleteInvitationRequestTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		deleteInvitationRequestTypeTypePropEnum = append(deleteInvitationRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *DeleteInvitationRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deleteInvitationRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DeleteInvitationRequest) validateType(formats strfmt.Registry) error {
...
func (m *DeleteInvitationRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeleteInvitationRequest) UnmarshalBinary(b []byte) error {
	var res DeleteInvitationRequest
