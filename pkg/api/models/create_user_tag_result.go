...
func (m *CreateUserTagResult) validateUserIds(formats strfmt.Registry) error {
...
func (m *CreateUserTagResult) validateUserTagID(formats strfmt.Registry) error {
