...
func (m *Activity) validateAppProofs(formats strfmt.Registry) error {
	if swag.IsZero(m.AppProofs) { // not required
		return nil
	}
...
func (m *Activity) contextValidateAppProofs(ctx context.Context, formats strfmt.Registry) error {
