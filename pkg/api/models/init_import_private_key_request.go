...
func (m *InitImportPrivateKeyRequest) validateOrganizationID(formats strfmt.Registry) error {
...
func (m *InitImportPrivateKeyRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *InitImportPrivateKeyRequest) validateTimestampMs(formats strfmt.Registry) error {
...
var initImportPrivateKeyRequestTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_INIT_IMPORT_PRIVATE_KEY"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		initImportPrivateKeyRequestTypeTypePropEnum = append(initImportPrivateKeyRequestTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *InitImportPrivateKeyRequest) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, initImportPrivateKeyRequestTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *InitImportPrivateKeyRequest) validateType(formats strfmt.Registry) error {
...
func (m *InitImportPrivateKeyRequest) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InitImportPrivateKeyRequest) UnmarshalBinary(b []byte) error {
	var res InitImportPrivateKeyRequest
