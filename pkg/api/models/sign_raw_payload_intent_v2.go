...
func (m *SignRawPayloadIntentV2) validateEncoding(formats strfmt.Registry) error {
...
func (m *SignRawPayloadIntentV2) validateHashFunction(formats strfmt.Registry) error {
...
func (m *SignRawPayloadIntentV2) validatePayload(formats strfmt.Registry) error {
...
func (m *SignRawPayloadIntentV2) validateSignWith(formats strfmt.Registry) error {
...
func (m *SignRawPayloadIntentV2) UnmarshalBinary(b []byte) error {
	var res SignRawPayloadIntentV2
