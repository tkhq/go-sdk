...
func (o *CreateWalletReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/submit/create_wallet] CreateWallet", response, response.Code())
	}
}
...
func (o *CreateWalletOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/submit/create_wallet][%d] createWalletOK  %+v", 200, o.Payload)
}
