...
func (o *GetWalletsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/query/list_wallets] GetWallets", response, response.Code())
	}
}
...
func (o *GetWalletsOK) Error() string {
	...
	return fmt.Sprintf("[POST /public/v1/query/list_wallets][%d] getWalletsOK %s", 200, payload)
}
