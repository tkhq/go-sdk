...
func (o *GetPrivateKeyOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/query/get_private_key][%d] getPrivateKeyOK  %+v", 200, o.Payload)
}
...
func (o *GetPrivateKeyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetPrivateKeyResponse)
