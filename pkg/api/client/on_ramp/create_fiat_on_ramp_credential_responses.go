...
func (o *CreateFiatOnRampCredentialReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateFiatOnRampCredentialOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/submit/create_fiat_on_ramp_credential] CreateFiatOnRampCredential", response, response.Code())
	}
}
...
func NewCreateFiatOnRampCredentialOK() *CreateFiatOnRampCredentialOK {
	return &CreateFiatOnRampCredentialOK{}
}
...
func (o *CreateFiatOnRampCredentialOK) Code() int {
	return 200
}

func (o *CreateFiatOnRampCredentialOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/submit/create_fiat_on_ramp_credential][%d] createFiatOnRampCredentialOK  %+v", 200, o.Payload)
}

func (o *CreateFiatOnRampCredentialOK) String() string {
	return fmt.Sprintf("[POST /public/v1/submit/create_fiat_on_ramp_credential][%d] createFiatOnRampCredentialOK  %+v", 200, o.Payload)
}

func (o *CreateFiatOnRampCredentialOK) GetPayload() *models.ActivityResponse {
	return o.Payload
}

func (o *CreateFiatOnRampCredentialOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
