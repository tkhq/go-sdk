...
func (o *GetOnRampTransactionStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetOnRampTransactionStatusOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/query/get_onramp_transaction_status] GetOnRampTransactionStatus", response, response.Code())
	}
}
...
func NewGetOnRampTransactionStatusOK() *GetOnRampTransactionStatusOK {
	return &GetOnRampTransactionStatusOK{}
}
...
func (o *GetOnRampTransactionStatusOK) Code() int {
	return 200
}

func (o *GetOnRampTransactionStatusOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/query/get_onramp_transaction_status][%d] getOnRampTransactionStatusOK  %+v", 200, o.Payload)
}

func (o *GetOnRampTransactionStatusOK) String() string {
	return fmt.Sprintf("[POST /public/v1/query/get_onramp_transaction_status][%d] getOnRampTransactionStatusOK  %+v", 200, o.Payload)
}

func (o *GetOnRampTransactionStatusOK) GetPayload() *models.GetOnRampTransactionStatusResponse {
	return o.Payload
}

func (o *GetOnRampTransactionStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetOnRampTransactionStatusResponse)
