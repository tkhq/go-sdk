...
func (o *GetAuthenticatorReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetAuthenticatorOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/query/get_authenticator] GetAuthenticator", response, response.Code())
	}
}
...
func (o *GetAuthenticatorOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/query/get_authenticator][%d] getAuthenticatorOK  %+v", 200, o.Payload)
}
...
func (o *GetAuthenticatorOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetAuthenticatorResponse)
