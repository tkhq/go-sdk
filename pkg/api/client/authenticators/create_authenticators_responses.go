...
func (o *CreateAuthenticatorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/submit/create_authenticators] CreateAuthenticators", response, response.Code())
	}
}
...
func (o *CreateAuthenticatorsOK) Error() string {
	...
	return fmt.Sprintf("[POST /public/v1/submit/create_authenticators][%d] createAuthenticatorsOK %s", 200, payload)
}
