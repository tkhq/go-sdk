...
func (o *DeletePoliciesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/submit/delete_policies] DeletePolicies", response, response.Code())
	}
}
...
func (o *DeletePoliciesOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/submit/delete_policies][%d] deletePoliciesOK  %+v", 200, o.Payload)
}
...
func (o *DeletePoliciesOK) GetPayload() *models.ActivityResponse {
	return o.Payload
}
