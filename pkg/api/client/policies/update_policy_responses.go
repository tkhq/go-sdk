...
func (o *UpdatePolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/submit/update_policy] UpdatePolicy", response, response.Code())
	}
}
...
func (o *UpdatePolicyOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/submit/update_policy][%d] updatePolicyOK  %+v", 200, o.Payload)
}
