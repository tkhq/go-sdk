...
// NewGetSmartContractInterfacesParams creates a new GetSmartContractInterfacesParams object,
...
func NewGetSmartContractInterfacesParams() *GetSmartContractInterfacesParams {
	return &GetSmartContractInterfacesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetSmartContractInterfacesParamsWithTimeout creates a new GetSmartContractInterfacesParams object
...
// NewGetSmartContractInterfacesParamsWithContext creates a new GetSmartContractInterfacesParams object
...
// NewGetSmartContractInterfacesParamsWithHTTPClient creates a new GetSmartContractInterfacesParams object
...
GetSmartContractInterfacesParams contains all the parameters to send to the API endpoint
	...
	for the get smart contract interfaces operation.
...
// Validate validates the params of the get smart contract interfaces operation
func (o *GetSmartContractInterfacesParams) Validate(formats strfmt.Registry) error {
	var res []error
	if o.Body != nil {
