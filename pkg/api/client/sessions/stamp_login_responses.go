...
func (o *StampLoginReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewStampLoginOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/submit/stamp_login] StampLogin", response, response.Code())
	}
}
...
func (o *StampLoginOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/submit/stamp_login][%d] stampLoginOK  %+v", 200, o.Payload)
}
...
func (o *StampLoginOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
