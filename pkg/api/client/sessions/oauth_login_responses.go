...
func (o *OauthLoginReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewOauthLoginOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/submit/oauth_login] OauthLogin", response, response.Code())
	}
}
...
func (o *OauthLoginOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/submit/oauth_login][%d] oauthLoginOK  %+v", 200, o.Payload)
}
...
func (o *OauthLoginOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
