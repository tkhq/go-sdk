...
func (o *PublicAPIServiceCreateSubOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 403:
		result := NewPublicAPIServiceCreateSubOrganizationForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 404:
		result := NewPublicAPIServiceCreateSubOrganizationNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPublicAPIServiceCreateSubOrganizationForbidden creates a PublicAPIServiceCreateSubOrganizationForbidden with default headers values
func NewPublicAPIServiceCreateSubOrganizationForbidden() *PublicAPIServiceCreateSubOrganizationForbidden {
	return &PublicAPIServiceCreateSubOrganizationForbidden{}
}

/*
PublicAPIServiceCreateSubOrganizationForbidden describes a response with status code 403, with default header values.

Returned when the user does not have permission to access the resource.
*/
type PublicAPIServiceCreateSubOrganizationForbidden struct {
	Payload interface{}
}

// IsSuccess returns true when this public Api service create sub organization forbidden response has a 2xx status code
func (o *PublicAPIServiceCreateSubOrganizationForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this public Api service create sub organization forbidden response has a 3xx status code
func (o *PublicAPIServiceCreateSubOrganizationForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this public Api service create sub organization forbidden response has a 4xx status code
func (o *PublicAPIServiceCreateSubOrganizationForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this public Api service create sub organization forbidden response has a 5xx status code
func (o *PublicAPIServiceCreateSubOrganizationForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this public Api service create sub organization forbidden response a status code equal to that given
func (o *PublicAPIServiceCreateSubOrganizationForbidden) IsCode(code int) bool {
	return code == 403
}

func (o *PublicAPIServiceCreateSubOrganizationForbidden) Error() string {
	return fmt.Sprintf("[POST /public/v1/submit/create_sub_organization][%d] publicApiServiceCreateSubOrganizationForbidden  %+v", 403, o.Payload)
}

func (o *PublicAPIServiceCreateSubOrganizationForbidden) String() string {
	return fmt.Sprintf("[POST /public/v1/submit/create_sub_organization][%d] publicApiServiceCreateSubOrganizationForbidden  %+v", 403, o.Payload)
}

func (o *PublicAPIServiceCreateSubOrganizationForbidden) GetPayload() interface{} {
	return o.Payload
}

func (o *PublicAPIServiceCreateSubOrganizationForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
// NewPublicAPIServiceCreateSubOrganizationNotFound creates a PublicAPIServiceCreateSubOrganizationNotFound with default headers values
func NewPublicAPIServiceCreateSubOrganizationNotFound() *PublicAPIServiceCreateSubOrganizationNotFound {
	return &PublicAPIServiceCreateSubOrganizationNotFound{}
}

/*
PublicAPIServiceCreateSubOrganizationNotFound describes a response with status code 404, with default header values.

Returned when the resource does not exist.
*/
type PublicAPIServiceCreateSubOrganizationNotFound struct {
	Payload string
}

// IsSuccess returns true when this public Api service create sub organization not found response has a 2xx status code
func (o *PublicAPIServiceCreateSubOrganizationNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this public Api service create sub organization not found response has a 3xx status code
func (o *PublicAPIServiceCreateSubOrganizationNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this public Api service create sub organization not found response has a 4xx status code
func (o *PublicAPIServiceCreateSubOrganizationNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this public Api service create sub organization not found response has a 5xx status code
func (o *PublicAPIServiceCreateSubOrganizationNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this public Api service create sub organization not found response a status code equal to that given
func (o *PublicAPIServiceCreateSubOrganizationNotFound) IsCode(code int) bool {
	return code == 404
}

func (o *PublicAPIServiceCreateSubOrganizationNotFound) Error() string {
	return fmt.Sprintf("[POST /public/v1/submit/create_sub_organization][%d] publicApiServiceCreateSubOrganizationNotFound  %+v", 404, o.Payload)
}

func (o *PublicAPIServiceCreateSubOrganizationNotFound) String() string {
	return fmt.Sprintf("[POST /public/v1/submit/create_sub_organization][%d] publicApiServiceCreateSubOrganizationNotFound  %+v", 404, o.Payload)
}

func (o *PublicAPIServiceCreateSubOrganizationNotFound) GetPayload() string {
	return o.Payload
}

func (o *PublicAPIServiceCreateSubOrganizationNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
