...
func (o *CreateUserTagReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/submit/create_user_tag] CreateUserTag", response, response.Code())
	}
}
...
// Code gets the status code for the create user tag o k response
func (o *CreateUserTagOK) Code() int {
	return 200
}

func (o *CreateUserTagOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/submit/create_user_tag][%d] createUserTagOK %s", 200, payload)
}
