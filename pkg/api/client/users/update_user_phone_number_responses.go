...
func (o *UpdateUserPhoneNumberReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateUserPhoneNumberOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /public/v1/submit/update_user_phone_number] UpdateUserPhoneNumber", response, response.Code())
	}
}
...
func NewUpdateUserPhoneNumberOK() *UpdateUserPhoneNumberOK {
	return &UpdateUserPhoneNumberOK{}
}
...
func (o *UpdateUserPhoneNumberOK) Error() string {
	return fmt.Sprintf("[POST /public/v1/submit/update_user_phone_number][%d] updateUserPhoneNumberOK  %+v", 200, o.Payload)
}
...
func (o *UpdateUserPhoneNumberOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
