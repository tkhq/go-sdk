...
func main() {
	...
	pkParams := signatures.NewPublicAPIServiceSignTransactionParams().WithBody(&models.V1SignTransactionRequest{
	...
	signResp, err := client.V0().Signatures.PublicAPIServiceSignTransaction(pkParams, client.Authenticator)
	if err != nil {
